...
<div id="sidebar">
    ...
    <? if($user->ultimo_acesso != ''){ ?>
	<p><b>Hora:</b> <?=$hora?>:<?=$minuto?></p>
	<p><b>Dia:</b> <?=$dia?></p>
    <p><b>Mês:</b> <?=$mes?></p>
	<p><b>Ano:</b> <?=$ano?></p>
    <p><b>Dia da Semana:</b> <?=$dia_semana?></p>
    <? } else { ?>
	...
	<p><b>Número de Acessos:</b> <?=$user->num_acessos?></p>
    <p><b>Seu Endereço IP:</b> <?=$info->session_ip_address?></p>
    <p><b>Seu Navegador:</b> <?=$info->session_user_agent?></p>
	<!-- End of infos -->
</div>