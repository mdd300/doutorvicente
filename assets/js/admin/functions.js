...
jQuery(document).ready(function() {
    ...
    $('.head-produtos').click(function(){
        $(this).next('.table-produtos').slideToggle('slow');
    })
    
    $('#form_novidades #categoria').change(function(){
...
function VerificaEmailUsuario(usuario_email)
{
    if($("#email").val() != "")
    {
        ...
        if(retorno){
            ...
            msg = '<label for="lf">E-mail: </label><input class="lf" name="email" id="email" type="text" value="" onblur="VerificaEmailUsuario(this.value)" /><span class="validate_error">Informe um email válido!</span><span class="validate_success"></span>';
            $('#msg_email').fadeIn("slow");
            $('#msg_email').html(msg);
