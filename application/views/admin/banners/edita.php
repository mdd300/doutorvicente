                    ...
                    <div id="main">
                        ...
                        <div class="pad20">
                            ...
                            <div id="tabs">
                                ...
                                <div id="tabs-1">
                                    <!-- Form -->
                                    <form method="post" action="admin/banners/atualizar" id="form_banners" enctype="multipart/form-data">
                                        ...
                                        <fieldset>
                                            ...
                                            <fieldset>
                                                ...
                                                <p>
                                                    ...
                                                    <input name="titulo1" id="titulo1" value="<?= @$banner->titulo1 ?>" type="text" />
                                                    <span class="validate_error"></span>
                                                    <span class="validate_success"></span>
                                                </p>
                                                <p>
                                                    <label for="lf">Título (segunda linha): </label>
                                                    <input name="titulo2" id="titulo2" value="<?= @$banner->titulo2 ?>" type="text" />
                                                    <span class="validate_error"></span>
                                                    <span class="validate_success"></span>
                                                </p>
                                            </fieldset>
                                            <fieldset>
                                                ...
                                                <p>
                                                    ...
                                                    <img src="<?= base_url(); ?>assets/uploads/banners/<?= $banner->path; ?>" width="150px" />
                                                    <span class="validate_error"></span>
                                                    <span class="validate_success"></span>
                                                </p>
                                                <p>
