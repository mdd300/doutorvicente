				...
				<div class="page_layout page_margin_top clearfix">
					...
					<div class="clearfix">
								...
								<div class="columns no_width">
										...
										<div class="gallery_box">
											<ul class="image_carousel">
												<li class="current_slide">
													<img src="assets/images/content/diagnostico-implantacional.jpg" alt=""/>
												</li>
											</ul>
										</div>
									</div>
									<div class="column_right">
										<div class="details_box">
											<div class="dropcap">
												O PGD pode ser visto como uma extensão do diagnóstico genético pré-natal.  O diagnóstico genético de gametas e embriões antes da implantação no útero, só foi possível após recentes avanços do campo da Fertilização in Vitro (FIV).
												<br><br>
												Da mesma forma que a FIV foi introduzida no mundo, a aplicação do PGD gerou considerável controvérsia no início. Apesar disso, após o relato da primeira gestação via PGD, o número de casos de diagnóstico pré-implantação tem aumentado constantemente. Desde 1997, mais de uma centena de bebês saudáveis vieram ao mundo graças a essa tecnologia.
											</div>
										</div>
									</div>
								</div>
						...
						<div class="gallery_item_details_list clearfix page_margin_top about-right">
							<ul class="columns no_width page_margin_top clearfix">
								Inserir animação II (dgpi.exe)
								<p>
								...
								<p>
									<img src="assets/images/pgd.jpg" alt="PGD" class="img-left">
								...
								<div class="logo-title">
									<h3>Biópsia do corpúsculo polar e embriões</h3>
								</div>
								...
								<p class="img-center">
									<img src="assets/images/biopsia_primeiro_corpusculo_polar.jpg" alt="Biopsia Primeiro Corpúsculo" width="290"><br>
									Biópsia do primeiro corpúsculo polar (Diagnóstico genético pré-concepcional) 
								</p>

								<p class="img-center">
									<img src="assets/images/biopsia_segundo_corpusculo_polar.jpg" alt=""><br>
									Biópsia do segundo corpúsculo polar
								</p>

								<p class="img-center">
									<img src="assets/images/blastomeros_6_8.jpg" alt=""><br>
									Biópsia de blastômeros em estágio de clivagem (embriões com 6 a 8 células)
								</p>

								<p class="img-center">
									<img src="assets/images/biopsiatrofoectoderma.jpg" width="407" alt="biopsiatrofoectoderma">
									<br>
								...
								<p class="img-center">
									<img src="assets/images/fish_blastocisto.jpg" alt="Fish Blastocisto">
								</p>
								...
								<div class="logo-title">
									<h3>FISH (Fluorescent "In situ" Hibridization)</h3>
								</div>
								...
								<p class="img-center">
									<img src="assets/images/cromossomos_x_y.jpg" alt="Cromossomos X e Y">
								</p>

								<div class="logo-title">
									<h3>Polimerase Chain Reaction (PCR) para detecção de defeitos em um único gene</h3>
								</div>
								

								<p>
									<img src="assets/images/pcr_dna.png" alt="PCR" class="img-left">A técnica da PCR revolucionou a análise do DNA. O procedimento envolve repetidas amplificações do DNA para obter cópias adequadas para análise. O uso dessa técnica permite detectar mutações em genes, corpúsculos polares ou blastômeros. 
									<br><br>
								...
								<p>
									<img src="assets/images/outros_problemas.png" alt="Outros problemas" class="img-right" width="260px;">
								...
								<div class="logo-title">
									<h3>CGH (Comparative Genomic Hybridization)</h3>
								</div>
								...
								<p>
									...
									<br><br>
									<span class="taC">
										<img src="assets/images/cgh.jpg" alt="">
									</span>
								</p>
							</ul>						
						</div>
